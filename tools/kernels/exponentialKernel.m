% Returns value of the exponential kernel computation run on two samples
...
% It differs only very slightly from GaussianKernel()

% sample usage: 
% ExponentialKernel([2 4], [6 5], 'sigma', 7)


function kernel_matrix_element = ExponentialKernel(sample1, sample2, varargin)
